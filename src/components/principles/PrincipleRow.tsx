...
export const PrincipleRow: React.FC<PrincipleRowProps> = ({
  ...
  return (
    <div
      ...
      className={`group relative py-8 sm:py-10 border-b border-white/[0.08] transition-all duration-300 focus:outline-none focus-visible:bg-white/[0.02] ${
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 items-start">
        ...
        <div className="md:col-span-2 flex items-center md:items-start justify-between">
          <span
            className={`font-mono-tech text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight transition-all duration-300 ${
              isHovered
                ? 'text-[#00F0FF] translate-x-1 sm:translate-x-2'
          ...
          <span className="md:hidden text-[10px] font-mono-tech px-2 py-0.5 rounded bg-white/[0.04] text-[#00F0FF] border border-white/[0.08]">
            {principle.focusTag}
          </span>
        </div>
        ...
        <div className="md:col-span-6 flex flex-col gap-3">
          <div className="flex items-center gap-3">
            ...
            <span className="hidden md:inline-block text-[10px] font-mono-tech px-2.5 py-0.5 rounded bg-white/[0.03] text-[#00F0FF] border border-white/[0.08]">
              {principle.focusTag}
            </span>
          </div>
          ...
          <div className="h-[1.5px] w-12 group-hover:w-36 bg-gradient-to-r from-[#00F0FF] to-transparent transition-all duration-500 rounded-full mt-1" />
        </div>

        {/* Detail Narrative (4 Cols) */}
        <div className="md:col-span-4 text-sm text-neutral-400 leading-relaxed pt-1">
