...
export const EngineeringPrinciples: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-1/4 left-1/3 w-[28rem] h-[28rem] bg-[#FF4500]/[0.025] rounded-full blur-[130px] pointer-events-none" />
        ...
        <div className="flex flex-col gap-3 mb-12 sm:mb-16">
          ...
          >
            <div>
              ...
              <p className="text-lg sm:text-xl text-neutral-600 dark:text-neutral-400 mt-2 font-medium max-w-2xl">
