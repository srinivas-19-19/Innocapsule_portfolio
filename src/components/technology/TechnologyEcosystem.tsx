...
export const TechnologyEcosystem: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 right-1/4 w-96 h-96 bg-[#FF4500]/[0.03] rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 relative z-10">
        ...
        <div className="flex flex-col gap-3 mb-12 sm:mb-16">
          ...
          >
            ...
            <p className="text-xs sm:text-sm font-mono-tech text-neutral-500 max-w-sm">
              // PRODUCTION TOPOLOGY
              <br />
              Decoupled micro-architectures orchestrated through strict typed contracts and automated deployment pipelines.
            </p>
          </motion.div>
        </div>
        ...
        <div className="hidden lg:grid grid-cols-12 gap-8 items-center">
          ...
          {/* Left: SVG Architecture Network Diagram (7 Cols) */}
          <div className="col-span-7 relative rounded-2xl bg-white dark:bg-[#090D15]/80 border border-black/[0.08] dark:border-white/[0.08] p-4 backdrop-blur-md overflow-hidden shadow-lg dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)] transition-colors">
            <div className="absolute inset-0 bg-tech-grid opacity-35 dark:opacity-25 pointer-events-none" />

            {/* Micro Header in Canvas */}
            <div className="flex items-center justify-between px-3 py-2 border-b border-black/[0.06] dark:border-white/[0.06] text-[10px] font-mono-tech text-neutral-500">
              <span className="text-neutral-700 dark:text-neutral-400 flex items-center gap-1.5 font-semibold">
                <Terminal className="w-3 h-3 text-[#FF4500]" />
                ...
                return (
                  <g key={`line-${cat.id}`}>
                    ...
                    <line
                      ...
                      x2={pos.x}
                      y2={pos.y}
                      stroke={isLineActive ? '#FF4500' : 'rgba(150, 150, 150, 0.2)'}
          ...
          <div className="col-span-5 flex flex-col gap-5">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="rounded-2xl bg-white dark:bg-[#090D15]/90 border border-black/[0.08] dark:border-white/[0.1] p-6 sm:p-7 backdrop-blur-md flex flex-col gap-6 shadow-md dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)] transition-colors"
              >
                ...
                <div className="flex items-center justify-between border-b border-black/[0.08] dark:border-white/[0.08] pb-4">
                  ...
                  <span className="text-[11px] font-mono-tech px-2.5 py-0.5 rounded-full bg-black/[0.04] dark:bg-white/[0.04] text-neutral-600 dark:text-neutral-400 border border-black/[0.06] dark:border-white/[0.08]">
                    VERIFIED STACK
                  </span>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-600 dark:text-neutral-300 mt-2.5 leading-relaxed">
                ...
                <div className="flex flex-col gap-2.5">
                  <span className="text-xs font-mono-tech text-neutral-500 dark:text-neutral-400 uppercase tracking-wider flex items-center gap-1.5 font-semibold">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {activeCategory.technologies.map((tech) => (
                      <span
                        key={tech}
                        className="text-xs font-medium px-3 py-1.5 rounded-lg bg-black/[0.04] dark:bg-white/[0.04] hover:bg-black/[0.08] dark:hover:bg-white/[0.08] border border-black/[0.06] dark:border-white/[0.08] text-neutral-800 dark:text-neutral-200 transition-colors"
                      >
                        {tech}
                      </span>
                    ))}
                ...
                {activeCategory.metrics && (
                  <div className="pt-4 border-t border-black/[0.06] dark:border-white/[0.06] flex items-center justify-between text-xs font-mono-tech">
                    <span className="text-neutral-500">
                      {activeCategory.metrics.label}:
                    </span>
                    <span className="text-[#FF4500] font-bold flex items-center gap-1.5">
            ...
            <div className="grid grid-cols-3 gap-2">
              {technologyCategories.map((c) => (
                <button
                  ...
                  className={`p-2.5 rounded-xl text-left border transition-all duration-200 text-xs font-mono-tech focus:outline-none focus-visible:ring-2 focus-visible:ring-[#FF4500]/50 ${
                    activeId === c.id
                      ? 'bg-orange-500/[0.08] dark:bg-white/[0.06] border-[#FF4500]/40 text-neutral-900 dark:text-white shadow-[0_0_12px_rgba(255,69,0,0.2)]'
                      : 'bg-black/[0.02] dark:bg-white/[0.02] border-black/[0.06] dark:border-white/[0.06] text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-200 hover:bg-black/[0.04] dark:hover:bg-white/[0.04]'
                  }`}
                >
                  <span className="text-[#FF4500] block text-[10px] font-bold">
                    {c.number}
                  </span>
